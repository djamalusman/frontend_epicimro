        ...
        text-decoration: underline;
            ...
            <div class="containers mt-20 mb-20">
                    ...
                    <div class="right-side">
                        <!-- Sign In Form -->
                        <form id="confirm-email" class="form login-form active">
                            @csrf
                            <input type="hidden" class="form-control" value="{{$email}}" id="email" name="email">
                            <h1>Confirmation Email <span>Anda!</span></h1>
                            <div class="form-group">
                                <label>Token</label>
                                <input id="token" type="text" class="form-control" name="token" placeholder="Input Nomor Token" required>
