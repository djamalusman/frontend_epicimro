                    ...
                    <div class="card-body">
                            <div class="form-group">
                                <label for="inputEmail4">Bank</label>
                                    ...
                                    <select name="idbank" id="idbank" class="form-control" disabled="" required>
                                        <option readonly value="" disabled {{ empty($data['selectedBankId']) ? 'selected' : '' }}>Pilih Bank</option>
                                        @foreach ($data['bankAccount'] as $bank)
                            ...
                            <div class="form-group" id="transferInfo">
                                ...
                                <select name="accountDetails" id="accountDetails" disabled="" class="form-control">
                            ...
                            <div class="form-group" id="transferInfo">
                                <label for="accountDetails">Pendidikan</label>
                                <select name="accountDetails" id="accountDetails" disabled="" class="form-control">
                                    <option value="" disabled selected> {{ $data['getdtTraining']->education }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail4">Jabatan</label>
                                <input type="text" name="amount" id="amount" readonly value="{{ isset($data['getdtTraining']->positionWork) != null ? $data['getdtTraining']->positionWork : 'belum bekerja' }}" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Keahlian Anda</label>
                                  <textarea id="summernotesklill" class="summernote-simple">{{ $data['getdtTraining']->writeskill }}</textarea>
                            </div>
                    </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                          ...
                          <div class="form-group ">
                              ...
                              <div class="input-group mb-3">
                                <input type="file" name="payment_proof" disabled="" id="payment_proof" class="form-control" accept=".jpg,.jpeg,.png,.pdf" required>
                          ...
                          <div class="form-group">
                            <label for="inputEmail4">Nama Training</label>
                            <input type="text" name="amount" id="amount" readonly value="{{$data['getdtTraining']->traning_name}}" class="form-control" required>
                          </div>
                          
                          <div class="form-group">
                            <label for="inputEmail4">Nama Perusahaan</label>
                            <input type="text" name="amount" id="amount" readonly value=" {{ isset($data['getdtTraining']->companyName) != null ? $data['getdtTraining']->companyName : 'belum bekerja' }}" class="form-control" required>
                          </div>
                         
                          <div class="form-group">
                            <label>Training yang Pernah di ikuti</label>
                              <textarea id="summernote" class="summernote-simple">{{ $data['getdtTraining']->trainingcourse }}</textarea>
                          </div>
                  </div>
              </div>
