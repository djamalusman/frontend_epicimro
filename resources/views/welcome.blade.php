...
<style>
    ...
    * {
    ...
    .upcomingtraininghover:hover {
        color: #ff873e; /* Warna teks saat hover */
    }
    ...
    .swiper-pagination {
    bottom: 10px; /* Position the pagination */
    }

    .custom-bullet {
        background: #d3d3d3; /* Light gray color for inactive dots */
        width: 10px;
        height: 10px;
        border-radius: 50%;
        display: inline-block;
    ...
    .custom-bullet-active {
        background: #ff7f50; /* Orange color for active dot */
        opacity: 1;
    }
            ...
            <div class="slides-container" id="slides">
                @foreach ($home as $valhome)
                    <div class="slide">
                        ...
                        <img alt="jobhub" class="CoverPhoto"src="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($valhome->file ?? '')) }}">
                    </div>
                @endforeach
            </div>
...
<section class="section-box  mt-md-40">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6">
                <h2 class="section-title mb-20 wow animate__animated animate__fadeInUp upcomingtraininghover">Upcoming Training</h2>
            </div>
...
<section class="section-box mt-40">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6">
                <h2 class="section-title mb-20 wow animate__animated animate__fadeInUp upcomingtraininghover">Upcoming Jobs</h2>
            </div>
            <div class="col-lg-6 col-md-5 text-lg-end text-start">
                    ...
                    <div class="swiper-container swiper-group-6">
                        <div class="swiper-wrapper pb-70 pt-5">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="item-logo">
                                    <a href="{{ $values->url }}"><img alt="jobhub" src="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($values->file ?? '')) }}" /></a>
                                </div>
                            </div>
                             @endforeach
                                ...
                                <div class="card-grid-2 hover-up">
                                    ...
                                    <div class="text-center card-grid-2-image">
                                        <a href="/detail-news/{{ base64_encode($item->id) }}">
                                            <div class="imgGrid-container">
                                                <figure>
                                                    <a href="/detail-news/{{ base64_encode($item->id)}}/{{Str::slug($item->title)}}">
                                                        <img class="imgGrid" src="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($item->file ?? '')) }}" />
                                                    </a>
                                                </figure>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card-block-info-news">
                                        <div class="card-title-news mt-5" >
                                            <a href="/detail-news/{{ base64_encode($item->id)}}/{{Str::slug($item->title)}}">{{ $item->title }}</a>
                                        </div>
                                        ...
                                        <div class="card-title-category-news mt-10">
                                            ...
                                            <div class="col-md-4" style="color:black">
                                                <span class="card-time">{{ \Carbon\Carbon::parse($item->implementation_date)->format('d M Y') }}</span>
                                            </div>
                                        </div>
