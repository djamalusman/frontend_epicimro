    ...
    <meta charset="utf-8" />
    <title>{{ $getdataDetail->traning_name }}</title>

    @if ($getdataDetail->tab_active == 1)
        <meta name="description" content="{{ $getdataDetail->abouttraining }}">
    @elseif ($getdataDetail->tab_active == 2)
        <meta name="description" content="{{ $getdataDetail->abouttrainer }}">
    @elseif ($getdataDetail->tab_active == 3)
        <meta name="description" content="{{ $getdataDetail->aboutcareer }}">
    @endif

    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="{{ $getdataDetail->traning_name }}" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:image" content="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($imagetraining->nama ?? '')) }}" />

    @if ($getdataDetail->tab_active == 1)
        <meta property="og:description" content={{ $getdataDetail->abouttraining }} />
    @elseif ($getdataDetail->tab_active == 2)
        <meta property="og:description" content={{ $getdataDetail->abouttrainer }} />
    @elseif ($getdataDetail->tab_active == 3)
        <meta property="og:description" content={{ $getdataDetail->aboutcareer }} />
    @endif
    ...
    <meta name="twitter:title" content="{{ $getdataDetail->traning_name }}">

    @if ($getdataDetail->tab_active == 1)
         <meta name="twitter:description" content={{ $getdataDetail->abouttraining }} />
    @elseif ($getdataDetail->tab_active == 2)
         <meta name="twitter:description" content={{ $getdataDetail->abouttrainer }} />
    @elseif ($getdataDetail->tab_active == 3)
         <meta name="twitter:description" content={{ $getdataDetail->aboutcareer }} />
    @endif

    <meta name="twitter:image" content="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($imagetraining->nama ?? '')) }}">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                        ...
                        <div class="sidebar-shadow">
                            ...
                            <div class="text-start mt-20">
                                ...
                                <a href ="#" class="btn btn-default mr-10" data-bs-toggle="modal" data-bs-target="#shareModal" style="font-size:15px;">
                                    Share Link
                                </a>
