...
<div class="archive-header pt-50 pb-50">
    <div class="container">
        <h3 class="mb-30  w-75 mx-auto">
            <h1 class="position-relative fs-2">{{$dataVisi->side_list}}</h1>
        </h3>
            ...
            <div class="col-lg-12 col-md-7">
                <div class="single-body">
                    ...
                    <div class="single-content">
                        ...
                        @foreach ($datalistVisimisi as  $val)

                            <h3 class="mb-0">{{$val->title}}</h4>
                                <figure class="mb-30">
                                    <img src="https://admin.trainingkerja.com/public/storage/{{ $val->file ?? '' }}" class="card-img-top" alt="course image" width="140px">
                                </figure>
