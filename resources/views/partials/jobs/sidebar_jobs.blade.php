@foreach ($trainings as $training)
    <div class="post-list-small-item d-flex"
        style="border-bottom: 1px solid #e0e0e0; padding-bottom: 15px; margin-bottom: 15px;">
        <figure class="thumb mr-15" style="margin-right: 15px;">
            <a href="/detail-course/{{ base64_encode($training->id) }}/{{ Str::slug($training->traning_name) }}">
        ...
        <div class="content">
            ...
            <div class="post-meta text-muted d-flex justify-content-between align-items-center mb-15"
