    ...
    <div class="card-job hover-up wow animate__animated animate__fadeIn">
        <div class="card-job-top">
            ...
            <div class="heading-image-rd">
                <a href="#">
                    <figure> <img class="imgGrid" style="height: 116px;width :120px;" src="{{ asset('https://admin.trainingkerja.com/public/storage/' . ($value->image_path ?? '')) }}" /></figure>
                </a>
            </div>
            <div class="card-job-top--info">
                <h6 class="card-job-top--info-heading"><a href="/detail-course/{{base64_encode($value->id)}}/{{$value->traning_name}}">{{$value->traning_name}}</a></h6>
                <div class="row  mt-10" >
